...
static int ft5x0x_ts_runtime_suspend(struct device *dev)
{
	...
	//ts = this_client->dev.p->driver_data;
...
/* add by cym 20140529 */
static const struct dev_pm_ops ft5x0x_pm_ops = {
	SET_SYSTEM_SLEEP_PM_OPS(ft5x0x_ts_suspend, ft5x0x_ts_resume)
	SET_RUNTIME_PM_OPS(ft5x0x_ts_runtime_suspend, ft5x0x_ts_runtime_resume,
			   NULL)
};
/* end add */
