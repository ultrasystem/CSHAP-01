...
struct s3c_hsotg *dev_controller;
...
static int __devinit s3c_hsotg_probe(struct platform_device *pdev)
{
	...
	/* Device should be disabled for host to work properly */
	s3c_hsotg_pullup(&hsotg->gadget, 0);
#endif

	dev_controller = hsotg;
	return 0;
